        ...
        <div className="container">
          <div className="row">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="mailto:ramavtar8032@gmail.com?body=fell free to type">
                    Gmail
                  </a>
                </li>
                <li>
                  <a href="tel:7061381581">Helpline No</a>
                </li>
              </ul>
            </div>
            <div className="footer-col">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/ramavtar-yadav-453627225/"
                  target="blank"
                >
                ...
                <a href="https://www.instagram.com/ramavtar_4546/" target="blank">
